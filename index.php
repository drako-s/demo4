    ...
    <nav class="navbar navbar-expand-lg">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-between gap-3" id="navbarScroll">
          ...
          <div class="order-lg-2"><?= Utils::buttonCTA($configData['orderID'], $content['web_target']) ?></div>
          <ul class="d-flex list-unstyled m-0 p-0 order-lg-1">
    ...
    <div class="d-flex flex-column justify-content-center align-items-center text-center">
      ...
      <div class="col-md-6 col-xl-3">
        <div class="d-flex flex-column gap-1 h-100 rounded-4 p-3 product-card">
          <div class="text-center d-flex flex-column gap-3 justify-content-center align-items-center">
            <div class="icon">
              <img src="https://www.stanislav-drako.cz/public/img/emojis/emoji<?= $i ?>.webp" alt="Emoji" class="img-fluid" width="128" height="128">
            </div>
            <h3><?= $f['f_title'] ?></h3>
          </div>            
          <div>
      ...
      <?php foreach($services as $s) : ?>
          <div class="col-lg-8">
            <div class="d-flex flex-column justify-content-between gap-2">
              ...
              <div class="border-bottom d-flex justify-content-between align-items-start flex-column flex-md-row">
                <h3><?= $s['services_title']?></h3>
                <div class="align-self-end">
                  <span class="fs-3"><?= $s['services_price']?></span>
                </div>  
              </div>
              <p class="pt-3">
                <?= $s['services_content']?>
  ...
  <div class="container-fluid overflow-hidden">
    <div class="row justify-content-center g-5">
      <div class="col-12 col-lg-8">
        <div class="d-flex bg-white rounded-4 flex-column justify-content-center align-items-center gap-3 py-5">
          <div class="col-10 p-lg-4 p-3">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6 px-5">
        <h6 class="fw-bold fs-5"><?= $content['c_person'] ?></h6>
      ...
      <div class="col-lg-4 col-md-6 px-5 py-5 py-lg-0">          
        <p class="d-flex flex-column">
      ...
      <div class="col-12 col-md-6 col-lg-4 d-flex flex-column justify-content-center gap-3 px-5">                          
      ...
      <div class="col-12">
        ...
        <div class="container">
          <div class="row flex-column flex-lg-row px-2 pt-3 justify-content-center">
